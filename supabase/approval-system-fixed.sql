...
BEGIN
    ...
    IF revenue < 500000 AND risk_factor <= 3 THEN
        RETURN 'category_1a';
    -- Category 1b: USD 0.5m-2m, RF ≤ 3  
    ELSIF revenue >= 500000 AND revenue < 2000000 AND risk_factor <= 3 THEN
        RETURN 'category_1b';
    -- Category 1c: USD 2m-5m, RF ≤ 5
    ELSIF revenue >= 2000000 AND revenue < 5000000 AND risk_factor <= 5 THEN
        RETURN 'category_1c';
    -- Category 2: USD 5m-30m, RF ≥ 5
    ELSIF revenue >= 5000000 AND revenue < 30000000 AND risk_factor >= 5 THEN
        RETURN 'category_2';
    -- Category 3: ≥ USD 30m, RF ≤ 10
    ELSIF revenue >= 30000000 AND risk_factor <= 10 THEN
        RETURN 'category_3';
