...
-- Insert users directly into public.users (without auth.users dependency)
...
-- Re-enable the foreign key constraint (optional - you can leave it disabled for development)
