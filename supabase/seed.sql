...
-- Insert users from the screenshot
...
('e8f27505-7998-42ae-854e-affa72ce5c1a', 'rajiv.patel83@example.net', 'Rajiv Patel', 'bu_director', 'Kuwait', 'Kuwait'),
...
('e8f27505-7998-42ae-854e-affa72ce5c1a', '{"widgets": ["overview", "analytics", "compliance"]}', '{"email": true, "browser": true, "sms": true}', 'Asia/Kuwait'),
...
('650e8400-e29b-41d4-a716-446655440004', 'Kuwait Infrastructure', 'Infrastructure foundation works', 1200000000, 7, 'contract_review', 4, 'Kuwait', 'Secant Piles', 'Kuwait Infrastructure Authority', 'e8f27505-7998-42ae-854e-affa72ce5c1a', NULL, 'e8f27505-7998-42ae-854e-affa72ce5c1a', '2024-01-12'),
...
('e8f27505-7998-42ae-854e-affa72ce5c1a', 'Approval Required', 'Gate 4 approval required for Kuwait Infrastructure project', 'approval_required', '650e8400-e29b-41d4-a716-446655440004', (SELECT id FROM public.gates WHERE project_id = '650e8400-e29b-41d4-a716-446655440004' AND gate_number = 4)),
